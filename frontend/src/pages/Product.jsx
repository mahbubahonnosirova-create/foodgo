      ...
      <div className="p-4">
        ...
        <div className="mt-4 flex items-center justify-between">
          ...
          <button
            ...
            className="flex h-11 w-11 items-center justify-center rounded-full bg-[#ff4d35] text-2xl font-light leading-none text-white shadow-[0_6px_18px_rgba(255,77,53,0.25)] transition duration-200 hover:scale-105 hover:bg-[#ef422b] active:scale-90"
          >
            +
          </button>
